...
void GPIO_PortPin_Init(GPIO_Port_Select GPIOSEL, uint32_t pin); // enable one pin as a digital GPIO 
...
void GPIO_WritePort(GPIO_Port_Select port, uint8_t pin);   //Write on a port 
